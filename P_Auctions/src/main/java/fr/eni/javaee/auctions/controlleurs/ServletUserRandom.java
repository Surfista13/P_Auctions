...
public class ServletUserRandom extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			final String HOST = "https://randomuser.me/api/";
			    ...
			    user.setCredit(0);
			    user.setRue(arr.getJSONObject(0).getJSONObject("location").getJSONObject("street").getString("number")+ " " + arr.getJSONObject(0).getJSONObject("location").getJSONObject("street").getString("name"));
